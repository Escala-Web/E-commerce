...
export const blueTheme = {
	colors: {
		primary: "#ffffff",  // Branco para áreas de fundo e texto
		secondary: "#0077b6",  // Azul mais intenso, destacando botões e links
...
export const greenTheme = {
	colors: {
		primary: "#ffffff",  // Fundo e texto principais
		secondary: "#28a745",  // Verde vibrante para chamar a atenção em botões
		background: "#e8f5e9",  // Fundo suave em verde claro
...
export const redTheme = {
	colors: {
		primary: "#ffffff",  // Branco para contraste com os elementos vibrantes
		secondary: "#e74c3c",  // Vermelho forte para botões de chamada para ação
		background: "#fff5f5",  // Fundo suave e acolhedor
...
export const purpleTheme = {
	colors: {
		primary: "#ffffff",  // Branco para clareza
		secondary: "#8200ff",  // Roxo vibrante para botões e links
		background: "#f3e5f5",  // Fundo roxo suave e acolhedor
...
export const orangeTheme = {
	colors: {
		primary: "#ffffff",  // Branco como cor base
		secondary: "#fd7e14",  // Laranja forte para chamar a atenção
		background: "#fff3e0",  // Fundo suave e acolhedor
